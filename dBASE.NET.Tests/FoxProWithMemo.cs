...
namespace dBASE.NET.Tests
{
	...
	public class FoxProWithMemo
	{
		...
		{
			AssertX.Equal(975, dbf.Records.Count, "Should read 975 records");
		}

		[Fact]
		public void FieldCount()
		{
			AssertX.Equal(59, dbf.Fields.Count, "Should read 59 fields.");
		}
